<properties 
    pageTitle="Cómo generar miniaturas utilizando Media Encoder estándar con .NET" 
    description="Este tema muestra cómo usar .NET para codificar un activo y generar miniaturas al mismo tiempo con Media Encoder Strandard." 
...
#<a name="how-to-generate-thumbnails-using-media-encoder-standard-with-net"></a>Cómo generar miniaturas utilizando Media Encoder estándar con .NET

Este tema muestra cómo usar Media Services .NET SDK para codificar un activo y generar miniaturas utilizando Media Encoder estándar. El tema define el XML y JSON miniaturas valores preestablecidos que puede utilizar para crear una tarea que realiza codificación y genera miniaturas al mismo tiempo. [Este](https://msdn.microsoft.com/library/mt269962.aspx) documento contiene descripciones de elementos de estos valores.
...
- Cargar la preestablecidos [XML](media-services-dotnet-generate-thumbnail-with-mes.md#xml) o [JSON](media-services-dotnet-generate-thumbnail-with-mes.md#json) que contienen la codificación preestablecidos, así como información necesaria para generar miniaturas. Puede guardar este [XML](media-services-dotnet-generate-thumbnail-with-mes.md#xml) o [JSON](media-services-dotnet-generate-thumbnail-with-mes.md#json) en un archivo y use el código siguiente para cargar el archivo.
...
##<a id="json"></a>Valores predeterminados JSON en miniatura
...
##<a id="xml"></a>Programación XML en miniatura
