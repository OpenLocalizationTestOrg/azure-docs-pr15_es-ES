...
Copie y pegue el código siguiente en el método **GetStartedDemo** debajo de la creación de la base de datos. Esta opción creará una colección de documento denominada *FamilyCollection_oa*.
