...
# <a name="run-sqoop-jobs-using-azure-powershell-for-hadoop-in-hdinsight"></a>Ejecutar trabajos Sqoop con Azure PowerShell para Hadoop en HDInsight

[AZURE.INCLUDE [sqoop-selector](../../includes/hdinsight-selector-use-sqoop.md)]

Obtenga información sobre cómo usar PowerShell Azure para ejecutar trabajos de Sqoop en HDInsight para importar y exportar entre HDInsight clúster y base de datos de SQL Azure o base de datos de SQL Server.

> [AZURE.NOTE] Los pasos de este artículo se pueden utilizar con cualquier un clúster basado en Windows o Linux de HDInsight; Sin embargo, estos pasos solo funcionará desde un cliente de Windows. Otros métodos de envío de trabajo, haga clic en el selector de tabulaciones en la parte superior del artículo.
...
## <a name="run-sqoop-using-powershell"></a>Ejecutar Sqoop con PowerShell

El siguiente script de PowerShell previamente procesa el archivo de origen y exporta a una base de datos de SQL Azure:
