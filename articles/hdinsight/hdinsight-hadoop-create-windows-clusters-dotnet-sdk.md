<properties
   pageTitle="Crear clústeres basados en Windows Hadoop en HDInsight con .NET SDK | Microsoft Azure"
    description="Obtenga información sobre cómo crear clústeres HDInsight de Azure HDInsight con .NET SDK."
   services="hdinsight"
   documentationCenter=""
   tags="azure-portal"
   authors="mumian"
...
# <a name="create-windows-based-hadoop-clusters-in-hdinsight-using-net-sdk"></a>Crear clústeres basados en Windows Hadoop en HDInsight con .NET SDK

[AZURE.INCLUDE [selector](../../includes/hdinsight-selector-create-clusters.md)]


Aprenda a crear clústeres HDInsight con .NET SDK. Para otra creación de clúster características y herramientas haga clic en la ficha, seleccione en la parte superior de esta página o vea [métodos de creación de clúster](hdinsight-provision-clusters.md#cluster-creation-methods).
...
HDInsight .NET SDK proporciona bibliotecas de cliente .NET que hacen que sea más fácil trabajar con HDInsight desde una aplicación de .NET Framework. Siga las instrucciones siguientes para crear una aplicación de consola de Visual Studio y pegue el código para crear un clúster.

La aplicación requiere un grupo de recursos de Azure y la cuenta de almacenamiento predeterminada.  El [Apéndice A](#appx-a-create-dependent-components) proporciona un script de PowerShell para crear los componentes dependientes.

**Para crear una aplicación de consola de Visual Studio**

1. Crear una nueva aplicación de consola de C# en Visual Studio.
2. Ejecute el siguiente comando de Nuget en la consola de administración de paquetes de Nuget.
...
7. Presione **F5** para ejecutar la aplicación. Debe abrir una ventana de consola y se mostrar el estado de la aplicación. Se le pedirá que introduzca sus credenciales de cuenta de Azure. Puede tardar varios minutos para crear un clúster de HDInsight.
...
##<a name="appx-a-create-dependent-components"></a>Componentes de AppX A crear dependientes

Siguiente Azure PowerShell script se pueden usar para crear los componentes dependientes necesarios en la aplicación .NET en este tutorial.
