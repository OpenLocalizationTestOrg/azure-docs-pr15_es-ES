...
3. Ahora se define el conjunto de datos para el almacén de datos de SQL. Empezaremos de la misma manera, haciendo clic en 'Nuevo conjunto de datos' y, a continuación, 'Almacén de datos de SQL Azure'.
