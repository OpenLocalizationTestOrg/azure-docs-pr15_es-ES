...
Este tutorial le ayuda a implementar la aplicación web de primera al [Servicio de la aplicación de Azure](../app-service/app-service-value-prop-what-is.md).
...
- Implementar código de ejemplo (elija entre ASP.NET, PHP, Node.js, Java o Python).
...
## <a name="deploy-a-web-app"></a>Implementar una aplicación web

Vamos a implementar una aplicación web en el servicio de aplicación de Azure.
...
1. Cambiar a un directorio de trabajo (`CD`) y clonar la aplicación de ejemplo similar a esta:
    ...
    ![Duplicar el código de ejemplo de aplicación para la aplicación web de primera en Azure](./media/app-service-web-get-started/2-clone-sample.png)

    Para * &lt;github_sample_url >*, utilice una de las siguientes direcciones URL, según el marco que desee:
