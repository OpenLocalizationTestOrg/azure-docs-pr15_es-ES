<properties
   pageTitle="Usar el conector para SMTP en aplicaciones de lógica | Servicio de aplicaciones de Microsoft Azure"
   description="Cómo crear y configurar la aplicación conector SMTP o API y usarla en una aplicación de la lógica de servicio de la aplicación de Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-smtp-connector"></a>Hemos mejorado el conector SMTP 
...
- [Obtenga más información sobre este nuevo conector](../connectors/connectors-create-api-smtp.md)
