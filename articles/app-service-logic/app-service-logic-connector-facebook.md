<properties
   pageTitle="Usar el conector de Facebook en aplicaciones de lógica | Servicio de aplicaciones de Microsoft Azure"
   description="Cómo crear y configurar la aplicación conector de Facebook o API y usarla en una aplicación de la lógica de servicio de la aplicación de Azure"
   services="logic-apps"
...
# <a name="weve-improved-the-facebook-connector"></a>Hemos mejorado el conector de Facebook 
...
- [Obtenga más información sobre este nuevo conector](../connectors/connectors-create-api-facebook.md)
